...
describe("Analyze Array Function", () => {
  ...
  test("should return an object that has the lowest number in the array as min", () => {
    expect(analyze.returnObject([1, 2, 3, 4])).toEqual({
      average: 2.5,
      min: 1,
      max: 4,
  ...
  test("should return an object that has the highest number in an array as max", () => {
    expect(analyze.returnObject([1, 2, 3, 4])).toEqual({
      average: 2.5,
      min: 1,
      max: 4,
  ...
  test("should return an object that has the length of the array as length", () => {
    expect(analyze.returnObject([1, 2, 3, 4])).toEqual({
      average: 2.5,
      min: 1,
      max: 4,
